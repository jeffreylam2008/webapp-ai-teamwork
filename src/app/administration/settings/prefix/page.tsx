...
export default function PrefixPage() {
  ...
  const STATUS_OPTIONS = useMemo(
    () => [
      { value: 'Active' as const, label: t.statusOptions.active },
      { value: 'Inactive' as const, label: t.statusOptions.inactive },
    ],
    [t]
  );
  ...
  const displayColumns = [
    ...
    },
    {
      ...
      key: 'prefix_code',
      sorter: (a: Prefix, b: Prefix) => (a.prefix_code || '').localeCompare(b.prefix_code || ''),
      width: 140,
    },
    {
...

    {
      ...
      dataIndex: 'status',
      key: 'status',
      sorter: (a: Prefix, b: Prefix) => (a.status || 0) - (b.status || 0),
      width: 120,
